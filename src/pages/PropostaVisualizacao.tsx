  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#1A1A1A] pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-10">
        <div className="bg-white border border-[#E8E4DF] shadow-xl p-8 md:p-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 pb-12 border-b border-[#F0EDEA]">
            ...
            <div className="flex items-center gap-4 bg-[#F8F9FA] p-4 border border-[#F0EDEA]">
              {getIcon()}
              <div>
                <p className="text-[10px] text-white/40-foreground uppercase tracking-widest font-bold">Tipo de Projeto</p>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-1">
                  <div className="flex items-center gap-2 text-white/40-foreground mb-1">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="bg-[#F8F9FA] p-6 border border-[#F0EDEA] relative overflow-hidden group hover:border-bronze/30 transition-all">
                  <p className="text-[10px] uppercase tracking-[0.2em] text-white/40-foreground mb-2 font-bold">Pacote Executivo</p>
                  ...
                  <p className="text-[9px] text-white/40-foreground mt-2 uppercase tracking-wider italic">*Projeto técnico e detalhamento para execução.</p>
                </div>
          ...
          <div className="bg-[#F8F9FA] p-8 border-t border-[#F0EDEA] text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <p className="text-[10px] text-white/40-foreground uppercase tracking-widest font-bold">
        ...
        <p className="text-center text-[10px] text-white/40-foreground mt-8 uppercase tracking-[0.3em] font-bold">
