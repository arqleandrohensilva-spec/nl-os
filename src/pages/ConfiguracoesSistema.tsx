      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {links.map((link) => {
          ...
          return (
            <div 
              key={link.id}
              className="bg-[#161616] border border-white/[0.12] border border-[#1E1E1E] p-6 hover:border-bronze transition-all flex items-start gap-4 group rounded-[1px]"
            >
              <div className="p-3 bg-white/[0.06] text-bronze rounded-[1px] group-hover:bg-bronze/10 transition-colors">
              ...
              <div className="flex-1 space-y-1">
                ...
                {link.editable ? (
                  <input 
                    ...
                    className="w-full bg-transparent border-none p-0 text-[11px] text-white/[0.4] focus:text-white/80 focus:ring-0 placeholder:text-white/[0.12] italic transition-colors"
                  />
                ) : (
                  <p className="text-[11px] text-white/[0.4] italic font-medium">{link.url}</p>
                )}
                
                <p className="text-[9px] text-white/[0.18] uppercase tracking-widest">{link.desc}</p>
              </div>
            </div>
          );
        })}
      ...
      <main className="flex-1 pl-[230px]">
        <div className="p-12 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Dropbox Card */}
            <div className="bg-white/[0.03] border border-white/[0.06] p-8 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-white/[0.4] uppercase tracking-widest">Armazenamento e Templates</p>
                    </div>
                  </div>
                  ...
                  <div className={cn(
                    ...
                    "bg-white/[0.06] border-white/[0.12] text-white/[0.4]"
                  )}>
                ...
                {lastSync && (
                  <p className="text-[9px] text-white/[0.18] uppercase tracking-widest mb-6 italic">
                ...
                <Button
                  ...
                  variant="outline"
                  className={cn(
                    "w-full h-12 border-white/[0.12] rounded-[2px] bg-white/[0.02] hover:bg-white/[0.06] text-[10px] uppercase tracking-[0.2em] font-bold transition-all",
                    dropboxStatus === 'connected' ? "text-white/[0.4]" : "text-white"
                  )}
                >
            ...
            <div className="bg-white/[0.01] border border-white/[0.06] p-8 opacity-40">
              ...
              <div className="space-y-4">
                ...
                <div className="h-4 w-1/2 bg-white/[0.06] animate-pulse" />
                <div className="h-4 w-2/3 bg-white/[0.06] animate-pulse" />
              </div>
              <p className="mt-8 text-[9px] text-white/[0.18] uppercase tracking-widest italic">Expansão em breve...</p>
            </div>
          </div>
        </div>
      </main>
