    ...
    <div className="flex min-h-screen items-center justify-center bg-white p-4">
      <div className="w-full max-w-[320px] flex flex-col items-center">
        <img 
          ...
          className="w-48 mb-2"
        />
        <p className="text-[10px] font-medium text-white/[0.4] uppercase tracking-[0.2em] mb-6">
        ...
        <form onSubmit={mode === 'login' ? handleLogin : handleForgot} className="w-full space-y-4">
          <Input
            ...
            className="h-11 border-white/[0.12] focus:border-bronze focus:ring-0 rounded-none text-xs tracking-wider"
          />
          ...
          {mode === 'login' && (
            <div className="relative">
              <Input
                ...
                className="h-11 border-white/[0.12] focus:border-bronze focus:ring-0 rounded-none text-xs tracking-wider pr-10"
              />
              <button
                type="button"
                onClick={() => setShowPassword((v) => !v)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-white/[0.4] hover:text-white transition-colors"
          ...
          {isLoading && (
            <p className="text-[10px] text-white/[0.4] uppercase text-center animate-pulse">
          ...
          <div className="text-center pt-2">
            <button
              ...
              className="text-[9px] uppercase tracking-[0.2em] text-white/[0.4] hover:text-bronze transition-colors"
            >
