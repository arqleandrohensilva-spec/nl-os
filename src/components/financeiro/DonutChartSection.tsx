...
const DonutChartSection: React.FC<DonutChartSectionProps> = ({ data, totalMonthly, onSliceClick }) => {
  ...
  return (
    <div className="sticky top-24 h-fit flex flex-col items-center p-6 bg-white/[0.03] border border-white/[0.12] rounded-[4px]">
      <div className="relative w-[200px] h-[200px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <span className="text-[10px] text-white/[0.4] uppercase tracking-widest font-dm-mono">Total Mensal</span>
        ...
        {data.map((entry, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] font-dm-mono text-white/[0.4]">{percent}%</span>
            </div>
          );
        })}
      </div>
