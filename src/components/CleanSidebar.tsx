...
/* -------------------------------------------------------------------------- */
/*  cn helper (inline — sem dependência externa)                              */
/* -------------------------------------------------------------------------- */
...
export interface SidebarProps {
  /** Configuração completa dos itens/seções do menu. */
  items: NavEntry[];
  /** Caminho atual (ex.: useLocation().pathname). */
  currentPath: string;
  /** Chamado ao clicar em um item (ex.: navigate). */
  onNavigate: (to: string) => void;
  /** Texto do quadradinho do logo. Default: "NL". */
  logoText?: string;
  /** Título ao lado do logo. Default: "NL OS". */
  title?: string;
  /** Dados do rodapé (usuário logado). Opcional. */
  user?: { name: string; role?: string; initials?: string };
  /** Ação de logout. Opcional — só mostra o botão se fornecido. */
  onLogout?: () => void;
}
...
/* -------------------------------------------------------------------------- */
/*  Seção (accordion + popover quando colapsado)                              */
/* -------------------------------------------------------------------------- */
...
const SectionAccordion = ({
  ...
  return (
    <div className="mb-1 relative">
      ...
      {/* Popover flutuante quando colapsado */}
...
const Sidebar = ({
  ...
  // Fecha o popover ao clicar fora ou trocar de rota
  React.useEffect(() => {
