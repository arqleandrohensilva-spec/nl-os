...
const corsHeaders = {
  ...
  'Access-Control-Allow-Headers': 'authorization, x-client-info, apikey, content-type, dropbox-api-arg, x-action, cache-control, pragma',
...
serve(async (req) => {
  ...
  // Auth Guard: Only authenticated users can use the Dropbox proxy
